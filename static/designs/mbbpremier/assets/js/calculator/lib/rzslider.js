...
.directive('rzslider', ['Slider', function(Slider)
{
  return {
    ...
    template:   '<span class="bar"></span>' + // 0 The slider bar
                ...
                '<span class="bubble limit rzLeft"></span>' + // 4 Floor label
                '<span class="bubble limit rzRight"></span>' + // 5 Ceiling label
                '<span class="bubble increaseNumber"></span>' + // 6 Label above left slider handle
